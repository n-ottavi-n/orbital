...
science instruments, created by NAIF, JPL. "
...
Ultraviolet and Visible Imaging Camera (UVVIS) Frame
   ...
   \begindata
      ...
      TKFRAME_-40002_ANGLES    = ( -0.00553269372882,
                                   -0.00104719755120,
                                    1.57690497917688 )
